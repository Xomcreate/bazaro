...
const FeaturedDealCard = () => (
  <div
    className="
      p-6 rounded-3xl 
      bg-white shadow-[0_8px_25px_rgba(0,0,0,0.15)]
      transition duration-500 hover:shadow-[0_12px_35px_rgba(255,69,0,0.35)]
    "
  >
    {/* Promo Tag */}
    <div
    ...
    <h3 className="text-xl font-bold text-gray-900 mb-2">
      Luxury Imported Sneakers
    </h3>

    {/* Price Section */}
    <div className="flex items-center justify-between">
      <div>
        <p className="text-2xl font-extrabold" style={{ color: COLOR_ORANGERED }}>
          ₦29,999
        </p>
...
export default function ShopA() {
  return (
    <div
      className="w-full bg-white flex justify-center py-14 md:py-20"
      style={{ minHeight: '50vh', fontFamily: 'Inter, sans-serif' }}
    >
      <div className="max-w-7xl w-full px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col text-center lg:text-left">
          ...
          >
            <Star className="w-4 h-4 mr-2" fill={COLOR_ORANGERED} />
            Ready to Ship
          </span>
          ...
          <h1
            className="text-4xl md:text-5xl lg:text-6xl 
                       font-extrabold mb-5 leading-tight tracking-tight"
