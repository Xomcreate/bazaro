...
function BannerCarousel() {
  ...
  const promotionBanners = [
    ...
    { title: "Bazaro Delivery", subtitle: "Fast & Free Shipping on Orders!", slug: "bazaro-delivery", style: { bgColor: "#38A169", titleColor: "#FFFFFF", subtitleColor: "#C6F6D5" }, graphic: () => <DeliveryTruck color="#81C784" /> },
    ...
    { title: "Bazaro Force", subtitle: "Join Today & Unlock Exclusive Perks!", slug: "bazaro-force", style: { bgColor: "#D53F8C", titleColor: "#FFFFFF", subtitleColor: "#FBB6CE" }, graphic: () => <AbstractFlow color="#F6AD55" /> },
