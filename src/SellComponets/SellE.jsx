...
function SellE() {
  ...
  // Determine number of visible cards for mobile/desktop
  ...
  return (
    ...
    >
      ...
      >
            ...
            >
              <div
                style={{
                  ...
                  margin: isMobile ? '0 auto' : '0', // Center the card on mobile
              ...
              >
                ...
                <div>
                  <p style={{ fontSize: '1.1em', fontStyle: 'italic', color: '#333', margin: '0 auto 20px auto', position: 'relative', zIndex: 1 }}>
                    {story.quote}
                  </p>
                </div>
                <div>
        ...
        {!isMobile && (
          <>
            <button onClick={prevSlide} style={{ ...navButtonStyle('left'), visibility: currentIndex === 0 ? 'hidden' : 'visible' }}>&lt;</button>
            <button onClick={nextSlide} style={{ ...navButtonStyle('right'), visibility: currentIndex >= totalStories - cardsVisible ? 'hidden' : 'visible' }}>&gt;</button>
          </>
        )}
      </div>
