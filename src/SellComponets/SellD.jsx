...
const FeatureIcon = ({ children }) => (
  <div
    style={{
      ...
      marginBottom: '10px',
      border: '2px solid orangered', // Border accent
      borderRadius: '8px',
      padding: '8px',
      display: 'inline-flex',
    }}
...
// Icon components for specific features
const ImageIcon = () => ( // Multiple Images
  <FeatureIcon><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></FeatureIcon>
);
const StockIcon = () => ( // Price, Stock, Category (Dollar/Settings)
  <FeatureIcon><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></FeatureIcon>
);
const EditorIcon = () => ( // Product Description Editor (Edit/Pen)
  <FeatureIcon><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></FeatureIcon>
);
const ShippingIcon = () => ( // Shipping & Delivery (Truck/Box)
  <FeatureIcon><path d="M10.5 4h8.5v6H10.5z"></path><path d="M2.5 18h18v4H2.5z"></path><path d="M7 10v8"></path><path d="M16 10v8"></path><circle cx="7" cy="18" r="2"></circle><circle cx="16" cy="18" r="2"></circle></FeatureIcon>
);
const DiscountIcon = () => ( // Discounts and Promotions (Tag/Offer)
  <FeatureIcon><path d="M20.5 12l-5.7 5.7L12 14l-5.7 5.7L3 12V3h9z"></path><line x1="7" y1="7" x2="7" y2="7"></line></FeatureIcon>
);
...
function SellD() {
  const features = [
    ...
    // Add one more feature to complete the 3x2 grid if needed, or leave it 3x2 for visual balance
  ...
  return (
    <div 
      style={{ 
        backgroundColor: 'white', // Ensure this is white for maximum crispness
        padding: '80px 20px', 
        ...
        {features.map((feature, index) => (
          <div
            ...
            style={{
              ...
              padding: '30px',
              borderRadius: '12px',
              border: '1px solid #ffefe8', // Very light orangered border
              textAlign: 'left',
